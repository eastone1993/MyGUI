...
::x603::
(
Thanks for reaching out. I see that your subscription was purchased for XXXXXX student licenses, while there are currently XXXXX students on the master roster. We'll need to remove any additional students from the master roster in order to make room for new students who'll need access. 
...
::x605::
(
Thanks for reaching out! We do have an auto-rostering process that allows you to  upload CSVs containing student data at any time to our SFTP server, and we'll apply updates nightly at 9pm PST to keep your IXL account in sync with your Student Information System.
...
::x612::
(
Thanks for reaching out. Since questions differ according to country edition on topics such as currency and measurement, after switching editions you and your students will no longer have access to the practice results that your students have completed in the US edition.
